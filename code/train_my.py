...
from networks.vnet_my import VNet#使用的网络结构最后加了3*3的矩阵
...
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')#注意源代码使用的是显卡1
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_tanh, outputs, z_out = model(volume_batch)
            z_out = torch.sigmoid(-1500*z_out)# 新增
            ...
            #consistency_loss = torch.mean((z_out - outputs_soft) ** 2)
            consistency_loss = F.mse_loss(z_out, outputs_soft)
    ...
    writer.close()
    # 可视化
    # cd model/test1_16labels_beta_0.3
    # tensorfoard --logir=log
